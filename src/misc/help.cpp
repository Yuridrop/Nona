...
void help(std::string command = "default") {
    ...
    */
    ...
    if (command == "default") {
        std::cout << MAG << "[ " << getCurrentTime() << " ]" << WHT << " Here are the commands:" << std::endl;
        ...
        std::cout << MAG << "[ " << getCurrentTime() << " ] " << RED << command << " is not a registered command." << std::endl;
    }
